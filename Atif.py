...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:William_Atif
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	print "  \033[1;91m«---------Developed By The Black Cats------------»" #Dev:William Atif
             ...
             ( (  \.---./  ) )
              '.__/o   o\__.'
                 {=  ^  =}
                  >  -  <
.-------------.""`-------`"".-------------.
: \033[1;92m     Hope You William Atif \033[1;93m :
'-----------------------------------------' 
                ___)( )(___
               (((__) (__)))"""
